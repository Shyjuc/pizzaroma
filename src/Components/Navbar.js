    ...
    <nav className="bg-[#322212] dark:bg-gray-800 shadow-inner-xl z-50">
        <div className="max-w-7xl mx-auto px-8">
            <div className="flex items-center justify-between h-16">
                <div className="w-full justify-between flex items-center">
                    ...
                    <img src={logo} classNameName="img-fluid animated" alt="PizzaRoma" />
                    </a>
        ...
        <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                ...
                <a className="text-white dark:text-white block px-3 py-2 rounded-md text-base font-medium" href="/#">
                    Menu
                </a>
                <a className="text-white hover:text-gray-800 dark:hover:text-white block px-3 py-2 rounded-md text-base font-medium" href="/#">
                    Content
