  ...
  return (
    <div className="rounded-lg shadow-lg bg-white max-w-sm mx-5 my-3">
      ...
      <div className="p-6">
        ...
        <span className="text-xs font-semibold inline-block py-1 px-2 rounded text-amber-600 bg-amber-200 uppercase last:mr-0 mr-1">
          L: ${props.ratel}
        </span>
        <span className="text-xs font-semibold inline-block py-1 px-2 rounded text-orange-600 bg-orange-200 uppercase last:mr-0 mr-1">
          J: ${props.ratej}
        </span>
        <button
          type="button"
