...
const HeroSection  = () =>{
  ...
  <div className="mx-auto max-w-7xl">
    <div className="relative z-10 bg-[#f0cfa5] pb-8 sm:pb-16 md:pb-20 lg:w-full lg:max-w-2xl lg:pb-28 xl:pb-32">
      <svg className="absolute inset-y-0 right-0 hidden h-full w-48 translate-x-1/2 transform text-white lg:block" fill="#f0cfa5" viewBox="0 0 100 100" preserveAspectRatio="none" aria-hidden="true">
      ...
      <main className="mx-auto mt-10 max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
        <div className="sm:text-center lg:text-left">
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
            ...
            <span className="block text-red-600 xl:inline">Super Delicious Pizzas!</span>
          </h1>
  ...
  <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
    <img className="h-56 w-full object-cover sm:h-72 md:h-96 lg:h-full lg:w-full" src={cover} alt="" />
